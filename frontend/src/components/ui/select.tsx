...
function SelectValue({ className, ...props }: SelectPrimitive.Value.Props) {
  return (
    <SelectPrimitive.Value
      ...
      className={cn("flex flex-1 text-left whitespace-normal wrap-break-word", className)}
      {...props}
    />
  )
}
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      {...props}
    >
      <SelectPrimitive.ItemText className="flex flex-1 gap-2 whitespace-normal wrap-break-word leading-snug">
        {children}
